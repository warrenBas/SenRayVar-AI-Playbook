# Object Classfication Demo for LEGO SPIKE Prime 

This project demonstrates how to use the **SenrayVar AI Camera** to  classfy objects
...
**1. Camera Model Configuration:**  
  a.  **Mode Config:** Select `Model config -> Classify -> Video selection`.  
  b.  **NAME_1:** Train for **NAME_1**, you can modify the name.  
  b.  **NAME_2:** Train for **NAME_2**, you can modify the name.  

<p align="center">
  <img src="../../assets/lego_spike_prome_examples/object_classfication_demo1.png" width="90%" />
</p>
<p align="center"><em>Figure 1: Camera App classfication training settings.</em></p>

**2. Camera Code:**  
![Camera Logic Setup](../../assets/lego_spike_prome_examples/object_classfication_demo2.png)
